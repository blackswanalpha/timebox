...
const ManualSessionEntry: React.FC = () => {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            await apiService.logManualSession(
                'default_user',
            ...
            <div className="max-w-5xl mx-auto w-full h-full flex flex-col p-4 md:p-8">
                ...
                <div className="flex flex-col gap-2 mb-8">
                    <button
                        ...
                        className="flex items-center gap-2 text-slate-500 hover:text-amber-600 transition-colors w-fit"
                    >
                        ...
                        <form id="manual-entry-form" onSubmit={handleSubmit} className="flex flex-col gap-6">
                            ...
                            <div className="flex flex-col gap-2">
                                ...
                                <div className="relative">
                                    <input
                                        ...
                                        className="w-full h-14 pl-4 pr-12 rounded-xl bg-white dark:bg-[#1e293b] border border-slate-200 dark:border-slate-700 text-slate-900 dark:text-white focus:ring-2 focus:ring-amber-500/20 focus:border-amber-500 outline-none transition-all"
                                        required
                                    />
                                    <div className="absolute right-4 top-1/2 -translate-y-1/2 pointer-events-none text-slate-400">
                                ...
                                <div className="flex flex-col gap-2">
                                    ...
                                    <div className="relative">
                                        <input
                                            ...
                                            className="w-full h-14 pl-4 pr-4 rounded-xl bg-white dark:bg-[#1e293b] border border-slate-200 dark:border-slate-700 text-slate-900 dark:text-white focus:ring-2 focus:ring-amber-500/20 focus:border-amber-500 outline-none transition-all"
                                            required
                                        />
                                    </div>
                                </div>
                            ...
                            <div className="flex flex-col gap-2">
                                ...
                                <textarea
                                    ...
                                    className="w-full min-h-[120px] p-4 rounded-xl bg-white dark:bg-[#1e293b] border border-slate-200 dark:border-slate-700 text-slate-900 dark:text-white focus:ring-2 focus:ring-amber-500/20 focus:border-amber-500 outline-none transition-all resize-y"
                                />
                            </div>
                            ...
                            <div className="flex flex-col-reverse sm:flex-row gap-4 pt-4">
                                ...
                                <button
                                    ...
                                    className="h-12 px-8 rounded-lg bg-amber-600 hover:bg-amber-700 text-white font-medium shadow-lg shadow-amber-500/20 transition-all flex items-center justify-center gap-2 disabled:opacity-50"
                                >
                    ...
                    <div className="lg:col-span-4 flex flex-col gap-6">
                        ...
                        <div className="bg-white dark:bg-[#1e293b] border border-slate-200 dark:border-slate-700 rounded-2xl p-6 flex flex-col gap-6 shadow-sm sticky top-6">
                            ...
                            <div className="bg-slate-50 dark:bg-[#0f172a] rounded-xl p-4 flex items-start gap-3 border border-slate-100 dark:border-slate-800">
                                <BoltIcon className="h-5 w-5 text-amber-500 mt-0.5" />
                            ...
                            {selectedTaskId && (
                                <div className="flex flex-wrap gap-2">
                                    <span className="inline-flex items-center gap-1.5 rounded-full bg-amber-50 dark:bg-amber-900/20 border border-amber-100 dark:border-amber-800 px-3 py-1 text-xs font-medium text-amber-700 dark:text-amber-300">
                        ...
                        {/* Tip Card */}
                        <div className="bg-amber-50 dark:bg-amber-900/10 border border-amber-100 dark:border-amber-500/20 rounded-2xl p-4 flex gap-3">
                            <div className="shrink-0 mt-0.5">
                                <div className="h-5 w-5 rounded-full bg-amber-100 dark:bg-amber-500/20 flex items-center justify-center">
                                    <span className="text-amber-600 dark:text-amber-400 font-bold text-xs">i</span>
                                </div>
                            </div>
